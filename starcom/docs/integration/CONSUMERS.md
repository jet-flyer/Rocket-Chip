...
| Host loopback / `RadioPort` / UDP / file / SPI-GPIO / PIO | Tests, desktop sims | Mailboxes, `udp_*`, `BusOps`, `pio_shift_*` | PHY tiers (18) |
...
| 18 | PHY adapter tiers + FPGA C&S | `adapters/` |
