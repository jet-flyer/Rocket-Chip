...
**Using it:** [`docs/USER_GUIDE.md`](docs/USER_GUIDE.md). Agents: [`docs/WORKING_HERE.md`](docs/WORKING_HERE.md). Map: [`docs/SAD.md`](docs/SAD.md). Handshake: [`docs/ICD.md`](docs/ICD.md). Proof order: [`docs/IVP.md`](docs/IVP.md). Phase: [`STATUS.md`](STATUS.md). Claims: [`docs/CONFORMANCE.md`](docs/CONFORMANCE.md). Clause walk: [`docs/COVERAGE.md`](docs/COVERAGE.md).
...
starcom/
  ...
  tests/             host tests
  docs/              DESIGN, SAD, ICD, CONFORMANCE, COVERAGE, IVP, GLOSSARY, …
