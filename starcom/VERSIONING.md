...
- `MINOR` = last **completed** Starcom IVP increment (`docs/IVP.md`). Increment 0+1 counts as 1. After increment 10 (COP-1 S4/S5): **`0.10.0-dev`**.
...
| `starcom::kVersionString` | `"MAJOR.MINOR.PATCH[-EXTRA]"` (e.g. `0.10.0-dev`) |
