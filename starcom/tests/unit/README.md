...
| `test_fuzz.cpp` | IVP 6 prefix smoke; IVP 24 book-max envelope + golden mutate + COP receive |
| `test_size.cpp` | IVP 24 sizeof report (`CoppEndpoint` / `Cop1Endpoint` vs 4 KiB Pico stack) |
