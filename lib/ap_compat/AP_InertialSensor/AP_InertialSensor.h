...
#include <stdint.h>
#include <atomic>  // PD12 fix: std::atomic for cross-core flag visibility
...
#endif
    // PD12 fix: Use std::atomic for cross-core memory visibility on FreeRTOS SMP
    // Reads use memory_order_acquire, writes use memory_order_release
