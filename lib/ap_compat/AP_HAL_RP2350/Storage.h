 ...
 *
 * Adapted from AP_HAL_ESP32/Storage.h for RP2350
 */
...
#define STORAGE_SECTOR_SIZE (4*1024)  // RP2350 has 4KB sectors (not 128KB like ESP32)
 ...
 *
 * Implements AP_HAL::Storage interface using AP_FlashStorage for
 * log-structured writes with wear leveling.
 *
 * Adapted from AP_HAL_ESP32/Storage.h
 */
...
private:
    ...
    // Flash callback functions (member functions for FUNCTOR_BIND_MEMBER)
    ...
    // AP_FlashStorage with Functor-bound member functions
