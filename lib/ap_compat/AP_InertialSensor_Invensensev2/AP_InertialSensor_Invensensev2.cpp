...
// Use ArduPilot header (we only customize the debug output)
...
// RocketChip: Disable debug output to avoid CLI spam
// Original ArduPilot code had printf-based debug() for temp resets
// This can be re-enabled with -DINV2_DEBUG=1 if needed for debugging
#ifdef INV2_DEBUG
...
#include <AP_InertialSensor/AP_InertialSensor_Invensensev2_registers.h>
