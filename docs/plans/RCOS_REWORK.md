...
**Status:** Sitting 3 closing (2026-09-07). I2C flags → shared_state (WN-315); pad is not a menu; `debug_eskf_live_poll`. WN-290: `ao_rcos.cpp` is target-only — HOST_TEST ifdefs/stubs removed (host CMake never compiled this file).
