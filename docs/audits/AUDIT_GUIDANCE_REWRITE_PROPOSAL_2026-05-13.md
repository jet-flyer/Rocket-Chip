...
- 3.5 **Section E — Agent Behavioral Guidelines.** Walk `.claude/AK_GUIDELINES.md` per-rule. Audit deliverable is whether the agent's recent commits demonstrate compliance.
