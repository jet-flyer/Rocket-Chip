...
struct ESKF {
    ...
    // IVP-55 note: may need 10-100× increase during boost/coast phases.
    // =================================================================
    ...
    // Consecutive rejection threshold for state machine use (IVP-55).
    ...
    // Public API for state machine (IVP-55) and explicit heading alignment.
