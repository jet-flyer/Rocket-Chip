...
- **Four-cycle plan — Cycle 4:** L2-P5 walk + disposition remediates on `main`. CLA snapshot + living RBM landed (`docs/audits/cla_rbm/cla_2026-08-24.md`, `docs/RBM/`). **Still paper:** close L2-P5 / L2-P10 in `PROBLEM_REPORTS.md` + Cycle-4 catchup doc (name those files). Cycles 1-3 closed.
