...
**New architecture (Stage 9, IVP-71):** Phase-scheduled Q/R matrices tied to state machine flight phases (IDLE→ARMED→BOOST→COAST→DESCENT→LANDED) + thin innovation-ratio adaptation layer + optional Bierman scalar measurement updates (GPS-conditional, boot-time detection). Captures 80-90% of IMM's benefit at near-zero complexity cost. Software identical across all tiers — Titan differs only in hardware.

**IVP restructuring (2026-03-03):** Stage 5 ends at IVP-48. Stage 6: Data Logging (IVP-49–56). Stage 7: Radio & Telemetry (IVP-57–65). Stage 8: Flight Director (IVP-66–70). Stage 9: Adaptive Estimation & Safety (IVP-71–74). Stage 10: Ground Station (IVP-75–80). Stage 11: System Integration (IVP-81–85). Total IVP count: 85.
