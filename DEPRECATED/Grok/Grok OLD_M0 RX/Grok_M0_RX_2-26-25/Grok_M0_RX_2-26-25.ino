#include <RH_RF69.h>
#include <MAVLink.h>  // ~MAVLink 1 ~included
  ...
  if (rf69.available()) {
    ...
    if (rf69.recv(mavlink_buf, &len)) {
      ...
      if (mavlink_bridge) {
              ...
              case MAVLINK_MSG_ID_SCALED_IMU:
                {
                  ...
                  Serial.println();
                  if (imu_hrs > 0) {
                    Serial.print(imu_hrs);
                    Serial.print(":");
                    Serial.print(imu_min);
                    Serial.print(":");
                  ...
                  Serial.print("  G,");
                  Serial.print(imu.xacc / 9800.0, 2);
                  Serial.print(",");
                  Serial.print(imu.yacc / 9800.0, 2);
                  Serial.print(",");
              ...
              case MAVLINK_MSG_ID_ATTITUDE:
                {
                  ...
                  Serial.println();
                  if (att_hrs > 0) {
                    Serial.print(att_hrs);
                    Serial.print(":");
                    Serial.print(att_min);
                    Serial.print(":");
              ...
              case MAVLINK_MSG_ID_LOCAL_POSITION_NED:
                {
                  ...
                  Serial.print(",");
                  Serial.print(pos.vx, 2);
                  Serial.print(",");
                  Serial.print(pos.vy, 2);
                  Serial.print(",");
              ...
              case MAVLINK_MSG_ID_GLOBAL_POSITION_INT:
                {
                  ...
                  Serial.print("  GPS,");
                  Serial.print(gps.lat / 1E7, 4);
                  Serial.print(",");
                  Serial.print(gps.lon / 1E7, 4);
                  Serial.print(",");
                  Serial.print(gps.alt / 1000.0, 1);
                  Serial.print(",");
                  Serial.print(gps.vx / 100.0, 2);
                  Serial.print(",");
                  Serial.print(gps.vy / 100.0, 2);
                  Serial.print(",");
        ...
        // ~No ~explicit ~sendACK() ~hardware ~ACK ~implicit ~via ~recv()
      }
    }
  } else {
