...
// Version 2.2 - Multi-board support

#ifndef ROCKET_CHIP_CONFIG_H
#define ROCKET_CHIP_CONFIG_H

// ===== BOARD DETECTION =====
#if defined(ARDUINO_ADAFRUIT_FEATHER_RP2350_HSTX)
  #define BOARD_NAME "RP2350 HSTX"
  #define BOARD_RP2350_HSTX
  #define NEOPIXEL_PIN 21
  #define HAS_PSRAM true
  #define HAS_DISPLAY false
  #define HAS_BUTTONS false
  #define PSRAM_ALLOC pmalloc
  #define RESTART_MCU rp2040.restart()
  #define GET_FREE_HEAP rp2040.getFreeHeap()
  #define GET_TOTAL_HEAP rp2040.getTotalHeap()

#elif defined(ARDUINO_ADAFRUIT_FEATHER_ESP32S3_TFT)
  #define BOARD_NAME "ESP32-S3 TFT"
  #define BOARD_ESP32S3_TFT
  ...
  #define TFT_DC 39
  #define TFT_RST 40
  #define PSRAM_ALLOC ps_malloc
  #define RESTART_MCU ESP.restart()
  #define GET_FREE_HEAP ESP.getFreeHeap()
  #define GET_TOTAL_HEAP ESP.getHeapSize()

#else
  #error "UNSUPPORTED BOARD! Currently supported: Adafruit RP2350 HSTX Feather, ESP32-S3 TFT Feather"
#endif

// ===== PSRAM CONFIGURATION =====
#if HAS_PSRAM
  #define USE_PSRAM_BUFFER true
  #define PSRAM_BUFFER_SIZE (7*1024*1024) // 7MB
  #define PSRAM_FLUSH_THRESHOLD 75
  #define MIN_FLUSH_SIZE (64*1024)
#else
  #define USE_PSRAM_BUFFER false
  #define PSRAM_BUFFER_SIZE (32*1024)  // 32KB fallback
  #define PSRAM_FLUSH_THRESHOLD 50
...
#define USE_LITTLEFS true             // DO NOT CHANGE - required for both platforms
